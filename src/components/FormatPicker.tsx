  ...
  return (
    <Popover.Root open={open} onOpenChange={setOpen}>
      <Popover.Trigger
        ...
        className={cn(
          'flex h-8 w-fit min-w-20 max-w-52 items-center justify-between gap-2 rounded-lg border border-input bg-background px-3 text-sm font-medium text-foreground shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground disabled:cursor-not-allowed disabled:opacity-50',
          triggerClassName
        )}
      >
